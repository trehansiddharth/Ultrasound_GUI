...
Driver Version: 1.1.16 18th February 2014
...
For the underlying dlls required please download the PicoScope 5000 Series (A API) Software Development Kit from 
...
The driver was created using MATLAB R2012b (32-bit for Windows) with Instrument Control Box v3.2.
...
* Fixed ps5000aSetResolution function so that the maximum possible resolution will be set
depending on the number of channels enabled if an invalid resolution is chosen.
